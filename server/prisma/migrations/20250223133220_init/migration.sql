...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('ONGOING', 'HOLD', 'COMPLETED');
...
-- AddForeignKey
ALTER TABLE "Attachment" ADD CONSTRAINT "Attachment_uploadedUser_fkey" FOREIGN KEY ("uploadedUser") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
